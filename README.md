...
| **배운 점** | <ul><li>단순 크롤링이 아니라, <strong>전처리 품질이 추천 모델 성능을 크게 좌우</strong>한다는 점을 직접 체감했습니다.</li> <br> <li>React ↔ Express ↔ Oracle ↔ Flask 추천 API로 이어지는 <strong>엔드투엔드 데이터 플로우</strong>를 구현하며, <br> 풀스택 관점의 설계 감각을 익혔습니다.</li> <br> <li>서버 접속 제한, 대용량 크롤링 병목 등 문제를 <strong>로그 분석과 구조 재설계</strong>로 해결하며 “양보다 구조”의 중요성을 배웠습니다.</li></ul> |
