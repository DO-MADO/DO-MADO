...
| **배운 점** | <ul><li><strong>Reverse Proxy 응용</strong>: 단일 IP에서 여러 서비스를 안전하게 분리·운영하는 기술 습득</li><li><strong>자동화의 가치</strong>: 수동 배포의 불안정성을 스크립트로 해결하며 운영 효율성 증대</li><li><strong>네트워크 체득</strong>: DNS부터 내부 서버 포트까지의 패킷 흐름을 직접 설계·트러블슈팅하며 네트워크·서버 개념을 이해</li></ul> |
