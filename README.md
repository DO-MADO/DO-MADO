...
| **목표** | ① <strong>실시간 데이터 스트리밍 파이프라인 구축 (Device → 서버 → Web UI)</strong> <br>② <strong>브라우저에서 그래프 기반 시각화/다운로드 기능 제공</strong> <br>③ <strong>운영·배포 자동화(원클릭 deploy, systemd 자동 실행)</strong> |
